...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        File myObj = new File("C:\\Users\\4079753\\Documents\\GitHub\\TPSIT\\CF\\src\\comuni.txt");
        String testo=new Scanner(myObj).nextLine().replaceAll(" ", "");
        int i=0;
        Map<String, String> catasto = new HashMap<String, String>();

        for (int j = 0; j < 5; j++) {

            
            System.out.println(testo.subSequence(testo.indexOf("codiceCatastale\":\"", i)+18,testo.indexOf("codiceCatastale\":\"", i)+18+4 ));
